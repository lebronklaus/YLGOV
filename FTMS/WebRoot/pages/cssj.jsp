...
<title>My JSP 'cssj.jsp' starting page</title>
...
<script type="text/javascript" src="../js/pages/cssj.js"></script>
<style>
body {
	padding: 0;
	margin: 0;
...
<body>
	<span id="city" style="display:none">西安市</span>
	<div id="main" style="width:100%;height:100%">
		<div class="easyui-layout" style="width:atuo;height:90%;">
			<div class="easyui-layout" data-options="fit:true">
				<div data-options="region:'west',split:true,border:false"
					style="width:10%">
					<span>选择你要查询的城市：</span><select class="easyui-combobox"
						id="cityselect" name="cityselect" style="width:100%;height:30px;"
						editable="false" panelHeight="auto"></select> <a
						href="javascript:void(0)" class="easyui-linkbutton"
						style="width:100%" onClick="xianqu()">按县/区统计</a> <a
						href="javascript:void(0)" class="easyui-linkbutton"
				...
				<div data-options="region:'center',border:false">
					...
					<div id="wenzi" align="center">
						<pre style="font-size:16px">截止<span id="tj_year"></span>年<span
								...
								id="tj_city"></span>共有<span id="tj_number"></span>农民获得证书，涉及<span
								id="tj_county"></span>个县</pre>
					</div>
				</div>
			</div>
		</div>
		<div class="easyui-panel" title="条件查询" style="width:100%;height:auto;">
			<span>县：</span><select class="easyui-combobox" name="county"
				id="county" style="width:10%;height:30px;" editable="false"
	...
	<div id="dlg" class="easyui-dialog"
		...
		<div id="dlg-buttons">
			<a href="csexport.action" class="easyui-linkbutton c6" iconCls="icon-ok"
