...
<style>
body{ padding:0;margin:0; /* height:100%;  */height:auto;width:auto}
...
#main{width:auto;/* height:100%  ; */height:auto; margin:0;}
/* by czt  */
...
<script language="javascript" type="text/javascript"> 
	...
	$("#show").load(function(){ 
	$(this).height(0); //用于每次刷新时控制IFRAME高度初始化 
	var height =  ($(window).height())*0.815;
	$(this).height( height );
	console.log(height+"tealist"); 
	});
	}
</script>
...
<body style="background:#fff;">
    <div id="main">
        ...
        <div class="easyui-layout" style="height:82%; ">
        	<div id="p" data-options="region:'west'" title="导航栏" style="width:15%;padding:0px">
          		 <div class="easyui-accordion" data-options="border:false" style="width:100%">
                   	<div title="数据统计" style="padding:10px; ">
                        <a href="javascript:void(0);" class="easyui-linkbutton" style="width:100%;height:32px" onClick="face()">首页</a>
                        <div style="margin:10px 0;"></div>
                        <a href="javascript:void(0);" class="easyui-linkbutton" style="width:100%;height:32px" onClick="qgsj()">全国数据</a>
                        <div style="margin:10px 0;"></div>
                       	<a href="javascript:void(0);" class="easyui-linkbutton" style="width:100%;height:32px" onClick="gscx()">各省查询</a>
                        <div style="margin:10px 0;"></div>
                      	<a href="javascript:void(0);" class="easyui-linkbutton" style="width:100%;height:32px" onClick="sxcx()">陕西省内查询</a>
                      	<div style="margin:10px 0;"></div>
                      	<a href="javascript:void(0);" class="easyui-linkbutton" style="width:100%;height:32px" onClick="ylcx()">杨陵区查询</a>
                    </div>
                    <div title="人员管理" style="padding:10px;">
                    	...
                    	<a href="javascript:void(0);" class="easyui-linkbutton" style="width:100%;height:32px" onClick="ksps()">成绩录入</a>
                       	<div style="margin:10px 0;"></div>
                       	<a href="javascript:void(0);" class="easyui-linkbutton" style="width:100%;height:32px" onClick="rysy()">证书审验</a>
                    </div>
        	...
        	<div data-options="region:'center'">
            	<!-- <iframe name="show" id="show" width="100%" height="99.6%" src="adminface" frameborder="0" style="background:#fff;"></iframe> -->
            	<iframe name="show" id="show" width="100%" height="99.6%" src="adminface.action" frameborder="0" scrolling="no" width="100%" height="99.6%" style="background:#fff;"></iframe>
            </div>
        </div>
        <div align="center" style="height:3%; background: #fff;"><p>Copyright ◎ 2016 杨凌农科培训综合信息服务平台All Rights Reserved</p>
			<p>联系电话：029-87036420    87036412  邮政编码：712100  联系地址：杨凌示范区新桥北路政务大厦</p></div>
       <!-- <div style="width: 1178px; margin: 0 auto;padding-top: 1px;padding-bottom: 20px;">
			<p>Copyright ◎ 2016 杨凌农科培训综合信息服务平台All Rights Reserved</p>
			<p>联系电话：029-87036420    87063412  邮政编码：712100  联系地址：杨凌示范区新桥北路政务大厦</p>
		</div> -->
    </div>
</body>
</html>
