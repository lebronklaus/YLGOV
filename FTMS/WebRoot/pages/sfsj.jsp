...
<title>My JSP 'sfsj.jsp' starting page</title>
...
<script type="text/javascript" src="../js/pages/sfsj.js"></script>
<style>
body {
	padding: 0;
	margin: 0;
...
<body>
	<span id="province" style="display:none"><s:property
			value="province" /></span>
		...
		<div class="easyui-layout" style="width:atuo;height:90%;">
			<div class="easyui-layout" data-options="fit:true">
				<div data-options="region:'west',split:true,border:false"
					style="width:10%">
					<span>选择要查询的省份：</span><select class="easyui-combobox"
						id="provinceselect" name="provinceselect" style="width:100%;height:30px;"
						editable="false" panelHeight="500"></select> <a
						href="javascript:void(0)" class="easyui-linkbutton"
						style="width:100%" onClick="chengshi()">按城市统计</a> <a
						href="javascript:void(0)" class="easyui-linkbutton"
				...
				<div data-options="region:'center',border:false">
					...
					<div id="wenzi" align="center">
						<pre style="font-size:16px">截止<span id="tj_year"></span>年<span
								...
								id="tj_province"></span>共有<span id="tj_number"></span>人次获得农民技术职称证书，涉及<span
								id="tj_city"></span>个市<span id="tj_county"></span>个县</pre>
					</div>
				</div>
			</div>
		</div>
		<div class="easyui-panel" title="条件查询" style="width:100%;height:auto;">
			<span>城市：</span><select class="easyui-combobox" name="city"
				id="city" style="width:10%;height:30px;" editable="false"
				panelHeight="auto"></select> <span>专业：</span><select
				class="easyui-combobox" id="prof1" name="prof1"
				...
				name="age" style="width:auto;height:30px;" editable="false"
				panelHeight="auto">
				<option value="不限">不限</option>
			...
			</select> <span>学历：</span><select class="easyui-combobox" name="education"
				id="education" style="width:auto;height:30px;" editable="false"
				panelHeight="auto">
				<option value="不限">不限</option>
	...
	<div id="dlg" class="easyui-dialog"
		style="width:95%;height:80%;padding:10px 20px" closed="true"
		buttons="#dlg-buttons">
		<div class="ftitle">
			<span>查询结果为:</span>
		</div>
		<table id="dg" title="" class="easyui-datagrid"
			style="width:100%;height:95%" rownumbers="true" fitColumns="true"
			singleSelect="false" selectOnCheck="true" checkOnSelect="true" pagination="true">
			<thead>
				<tr>
					<th
		...
		<div id="dlg-buttons">
			<a href="sfexport.action" class="easyui-linkbutton c6" iconCls="icon-ok"
