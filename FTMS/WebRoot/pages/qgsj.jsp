...
<title>My JSP 'qgsj.jsp' starting page</title>
...
<script type="text/javascript"
	src="../echarts-2.2.7/build/dist/echarts.js"></script>
<script type="text/javascript" src="../js/pages/qgsj.js"></script>
<style>
body {
	padding: 0;
	margin: 0;
...
<body>
			...
			<div class="easyui-layout" data-options="fit:true">
				<div data-options="region:'west',split:true,border:false"
					...
					<a href="javascript:void(0)" class="easyui-linkbutton"
						style="width:100%" onClick="shengfen()">按省份统计</a> <a
				...
				<div data-options="region:'center',border:false">
					...
					<div id="wenzi" align="center"><pre style="font-size:16px">截止<s:property value="year"/> 年<s:property value="month"/>月<s:property value="day"/>日，全国<s:property value="total"/>人次获得农民技术职称证书，涉及<s:property value="provincesum"/>个省<s:property value="citysum"/>个市<s:property value="countysum"/>个县</pre></div>
				</div>
			</div>
		</div>
		<div class="easyui-panel" title="条件查询" style="width:100%;height:auto;">
			<span>省份：</span><select class="easyui-combobox" id="province"
				name="province" style="width:10%;height:30px;" editable="false"
				panelHeight="500"></select> <span>专业：</span> <select
	...
	<div id="dlg" class="easyui-dialog"
		...
		<table id="dg" title="" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th	data-options="field:'province',formatter:formatprovince,width:80">省</th>
		...
		<div id="dlg-buttons">
			<a href="qgexport.action" class="easyui-linkbutton c6"
				iconCls="icon-ok" style="width:90px">导出</a>
			<a href="javascript:void(0)" class="easyui-linkbutton"
