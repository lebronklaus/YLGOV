...
<script type="text/javascript" src="shizi/shizijs/jquery.media.js"></script>
...
<div class="xq_zhong_3">
		<div class="xq_div2_div1_3">
				<div class="xq_div2_top">
					...
					<div class="xq_top_wen_3">
						<span>您当前位置： 培训资源 ><a id ="peixun">专家文稿库</a></span>					
					</div>				
				</div>
		</div>
    ...
    <input type="hidden" value="<s:property value="path"/>" id="addr"/>
 	 <div id="video" class="tempwg"><div id="a1" style="position: relative; display: block; "><a  class = "media" href = "<s:property value="path"/>" id = "PDFFILE"></a> </div></div> 
