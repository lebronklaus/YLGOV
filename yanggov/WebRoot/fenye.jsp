...
<script language="javascript" type="text/javascript"> 
	...
	$("#rightFrm").attr("src",host+"/yanggov/res/reslist.action");
...
function base(){
	changebg(jidi);
	var host = "http://"+window.location.host;
	$('#rightFrm').attr("src",host+"/yanggov/base/baselist.action");
	$('#peixun').html("培训基地");
...
function tea(){
	changebg(laoshi);
	var host = "http://"+window.location.host;
	$('#rightFrm').attr("src",host+"/yanggov/teacher/tealist.action");
	$('#peixun').html("培训师资");
	changebg();
}
function gotosearch(){
...
<div class="xq_zhong">
				...
				<ul class="infoList">
					<s:iterator value="%{#application.peixun}">
							<li style="overflow:hidden;" >
								...
								<div class="wen">
									<a href="system/layout/addMoreNewss.action?id=<s:property value='dtid'></s:property>"><s:property	value="title"></s:property></a>
								</div>
							</li>
					</s:iterator>
				</ul>
	...
	<div class="xq_right">
		<div id="kuang" style="height: 1000px"class="xq_right_div2">
			...
			<div  class="xq_div2_div2">
				<div id="fenye" class="xq_div2_div3_sp">
						<ul id="ullist" class="ula">
						</ul>
				</div>
				<div style="clear:both;"></div>
				<div id="split" class="pagin">
							<div id="allpages" class="message">
									共
