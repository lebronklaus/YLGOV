...
<script type="text/javascript" src="system/layout/back/js/tzlist.js"></script>
<style>
body {
	padding: 0;
	margin: 0;
...
<script type="text/javascript">
	$(function() {
		$('#dg').datagrid({
			...
			url : 'Tnews11.action',//url调用Action方法  
			loadMsg : '数据装载中......',
	...
	{	var s=$('#name').val();
			...
			collapsible : true,//显示可折叠按钮  
			toolbar : "#tb",//在添加 增添、删除、修改操作的按钮要用到这个  
			url : 'Tnews1search.action?s='+encodeURI(encodeURI(s)),//url调用Action方法  
...
<body>
	<table id="dg" title="通知列表" class="easyui-datagrid"
...
<!-- 			 <span id="teacher_workplace" style=" text-indent:30px;" ></span> -->
...
<!-- 			<label>个人简介：</label> -->
<!-- 			<pre -->
<!-- 				style="white-space: pre-wrap; white-space: -moz-pre-wrap; white-space: -pre-wrap; white-space: -o-pre-wrap; word-spacing: break-word;" -->
<!-- 				id="teacher_profile"></pre> -->
<!-- 		</div> -->
