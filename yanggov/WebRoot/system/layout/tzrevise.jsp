...
<script type="text/javascript" src="system/layout/back/js/tzeidt.js"></script>
	...
	<s:iterator value="post">
		<div id="main" align="center" style="padding:10px; height:auto;">
			<fieldset style="width: 757px">
				<legend style="font-size:20px;font-family: 微软雅黑;font-weight:bold;">通知公告编辑</legend>
				...
				<table style="margin-top: 20px;">
					...
					<tr>
						...
						<td width="624px" colspan="3"><input name="tt.title"
							id="title" class="easyui-textbox" style="width:98%;height:30px;"
							value="<s:property value="title"></s:property>"></td>
					</tr>
					...
					<tr>
						...
						<td width="270"><input name="tt.author" id="author"
							class="easyui-textbox" style="width:250px;height:30px;"
							value="<s:property value="author"></s:property>"><span><font
					...
					<tr>
						...
						<td colspan="3" width="624px"><textarea
								style="width:98%;height:330px;" class="form-control"
								id="inputNote" rows="5" name="tt.teacher_profile">
					...
					<tr>
						...
						<td align="center" height="50px" colspan="3"><iframe
								name="framer" src="system/layout/uploadtz.jsp" width=100%
				...
				<div style="text-align:center;padding:10px">
					<a href="javascript:void(0)" class="easyui-linkbutton"
						iconCls="icon-ok" style="width:20%;height:30px;"
		...
		<span id="tzid" style="display:none;"><s:property value="id" />
		</span>
	</s:iterator>
	<!--main -->
