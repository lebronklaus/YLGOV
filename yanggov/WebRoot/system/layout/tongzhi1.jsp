...
<script type="text/javascript" src="system/layout/back/js/addtz.js"></script>
...
<body>
	...
	<legend style="font-size:20px;font-family: 微软雅黑;font-weight:bold;">通知公告</legend>
		<table style="margin-top: 20px;">
			
			
			<tr>
				<td width="84" height="38" class="xiugai"><span>标题：</span></td>
		...
		<tr>
		  <td height="38" class="xiugai"><span> 作者：</span></td>
		...
		<tr>
		<td height="38" class="xiugai"><span>备注：</span></td>
		<td>
		<textarea     id="remark"  class="easyui-textbox"
			...
			<tr>
				...
				<td align="center" height="50" colspan="4"><iframe name="framer"
						src="system/layout/uploadtz1.jsp" width=100% height="100%" frameborder="0"></iframe></td>
			</tr>
