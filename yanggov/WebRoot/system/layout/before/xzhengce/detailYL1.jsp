...
function gotosearch(){
	...
	<body>
		...
		<div class="top">
			...
			<div class="logo">
				<a href=""><img src="<%=path%>/images/logo.png" />
				</a>
			</div>
		</div>
		...
		<div class="xq_zhong">
			<div class="xq_left">
				<div class="xq_left_div">
					...
					<div class="xq_div_div2">
						<ul>
							<li class="qie">
								<a href="<%=path%>/system/layout/zszcnews.action?mark=0">中省政策</a>
							</li>
							<li class="li" style="background:#f0f0f0;">
								<a href="<%=path%>/system/layout/ylzcnews.action?mark=1">杨凌政策</a>
							</li>
						</ul>
					</div>
					<div style="clear: both;"></div>
					...
					<div class="xq_div1_div2">
						...
						<s:iterator value="%{#application.newsList}">
							<li style="overflow:hidden;">
								...
								<div class="wen">
									<a href="system/layout/addMoreNewss.action?id=<s:property value='id'></s:property>"><s:property	value="title"></s:property></a>
								</div>
							</li>
							 </s:iterator>
						</ul>
			...
			<div class="pagin">
				...
				<ul class="paginList">
					<li class="paginItem">
						<a href="<%=path %>/system/layout/ylzcnews.action?PageNow=1&mark=1"><span class="pagepre">首页</span>
						</a>
					</li>
					<li class="paginItem">
					<s:if test="pageNow!=1">
						<a href="<%=path %>/system/layout/ylzcnews.action?PageNow=<s:property value='pageNow-1'/>&mark=1"><span
					...
					<li class="paginItem current">
							<s:if test="pageNow+1 <= pageCount"><a style="cursor:pointer" href="<%=path %>/system/layout/ylzcnews.action?PageNow=<s:property value='pageNow+1'/>&mark=1"><s:property value='pageNow+1'/></a>
							</s:if>
					</li>
					<li class="paginItem current">
						<s:if test="pageNow+2 <= pageCount "><a style="cursor:pointer" href="<%=path %>/system/layout/ylzcnews.action?PageNow=<s:property value='pageNow+2'/>&mark=1"><s:property value='pageNow+2'/></a>
							</s:if>
					</li>
<!--         下一页-->
					<li class="paginItem">
					...
					<li class="paginItem">
						<a href="<%=path %>/system/layout/ylzcnews.action?PageNow=<s:property value='pageCount'/>&mark=1"><span
