...
<div class="xq_zhong_3">
		<div class="xq_div2_div1_3">
				<div class="xq_div2_top">
					...
					<div class="xq_top_wen_3">
						<span>您当前位置：资源内容> <a id ="peixun">政策信息</a></span>					
					</div>				
				</div>
		</div>
	  <div style="width:100%;">
   ...
   <table class="tables" style="overflow: scroll; width:100%; text-align: center;">
   <thead>
<tr   >
...
<table class="tables" style=" overflow: scroll; ">
   <tbody>
...
<!--    <pre style="line-height: 28px;   text-indent: 20px;text-align: left;"> -->
