...
<div class="main">
		<div class="right">
			<p class="title">您现在的位置：<a href="<%=path %>/getAllList.action">首页</a> &gt; <a href="<%=path %>/system/layout/morenewszc.action">政策信息</a></p>
			<div class="content">
				<ul>
					<div class="articlelist">


				<iframe name="right" id="rightMain" src="./before/xzhengce/moreListZC.jsp"
...
<br class="clearfloat">
		...
		<div class="left">
			...
			<div class="left_cont">
				<ul>
					<li><a href="<%=path %>/system/layout/zszcnews.action?mark=0" target="right">中省政策</a></li>
					<li><a href="<%=path %>/system/layout/ylzcnews.action?mark=1" target="right">杨凌政策</a></li>
