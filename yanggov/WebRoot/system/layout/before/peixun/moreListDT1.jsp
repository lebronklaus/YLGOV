							...
							<s:iterator value="%{#application.newsListdt}">
								<ul class="ula">
									<li style="overflow: hidden;">
										...
										<div class="wen">
											<span style="padding-left: 9px;"><s:property
													value="date" />
											</span>
											<a
												href="system/layout/addMoreNewssdt.action?id=<s:property value='dtid'></s:property>">
					...
					<div class="xq_div6">
						...
						<div class="pagin">
							<div class="message">
								...
								页记录，当前显示第
								<i class="blue"><s:property value="#application.pagenowdt" />
								</i>页
							</div>
							...
							<ul class="paginList">
								<li class="paginItem">
									<a
										href="<%=path%>/system/layout/morenewsdtwk.action?PageNow=1"
										target="right"><span class="pagepre">首页</span> </a>
								</li>
								<li class="paginItem">
									<s:if test="#application.pagenowdt!=1">
										<a
											href="<%=path%>/system/layout/morenewsdtwk.action?PageNow=<s:property value='#application.pagenowdt-1'/>"
								...
								<li class="paginItem">
									<a href="javascript:;"><s:property
											value='#application.pagenowdt' />
									</a>
								</li>

								<li class="paginItem current">
									<s:if test="#application.pagenowdt+1 <= #application.pagecountdt">
										<a style="cursor: pointer"
											href="<%=path%>/system/layout/morenewsdtwk.action?PageNow=<s:property value='#application.pagenowdt+1'/>"><s:property
												value='#application.pagenowdt+1' />
										</a>
									</s:if>
								</li>
								<li class="paginItem current">
									<s:if test="#application.pagenowdt+2 <= #application.pagecountdt ">
										<a style="cursor: pointer"
											href="<%=path%>/system/layout/morenewsdtwk.action?PageNow=<s:property value='#application.pagenowdt+2'/>"><s:property
												value='#application.pagenowdt+2' />
										</a>
									</s:if>
								</li>
								<!--                   下一页-->
								...
								<li class="paginItem">
									<a
										href="<%=path%>/system/layout/morenewsdtwk.action?PageNow=<s:property value='#application.pagecountdt'/>"
