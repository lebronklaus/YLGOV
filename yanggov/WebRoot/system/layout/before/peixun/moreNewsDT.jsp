...
<div class="main">
		<div class="right">
			<p class="title">您现在的位置：<a href="<%=path %>/getAllList.action">首页</a> &gt; <a href="<%=path %>/system/layout/morenewsdt.action">工作动态</a></p>
			<div class="content">
				<ul>
					<div class="articlelist">


				<iframe name="right" id="rightMain" src="./before/peixun/moreListDT.jsp"
