		...
		<div class="xq_div2_div1_3">
				<div class="xq_div2_top">
					...
					<div class="xq_top_wen_3">
						<span>您当前位置：资源内容> <a id ="peixun">工作动态</a></span>					
					</div>				
				</div>
		</div>
	  <div style="width:100%;" >
...
<!--  进行图片的shixanshi -->
 	<% 
 	int a=(Integer)application.getAttribute("image3"); 
 	if(a==0) {%> 
<!-- 	   <tr class="image1"> -->
<!--    <td> -->
<!--     <img  src="<%=basePath%>uploadzc/<s:property value="filename" ></s:property>"/> -->
<!--    </td> -->
<!--    </tr> -->
     <%}  
      %> 
...
<!-- 	<pre style=" text-indent: 20px;text-align: left;margin:10px;border-radius: 4px;font-size: 14px;font-family: 微软雅黑;"> -->
