...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<base href="<%=basePath%>" />
		<link href="<%=path%>/shizi/shizicss/bootstrap.min.css"
			rel="stylesheet" />
		<link href="<%=path%>/shizi/shizicss/new.css" rel="stylesheet" />
		<link href="<%=path%>/shizi/shizicss/font-awesome.min.css"
			rel="stylesheet" />
		<style type="text/css">
.tables thead {
		...
		<div class="xq_zhong_3">
			<div class="xq_div2_div1_3">
				<div class="xq_div2_top">
					...
					<div class="xq_top_wen_3">
						<span>您当前位置: 资源内容> <a id="peixun">通知公告</a>
						</span>
					</div>
				</div>
			</div>
			<div style="width: 100%;  text-align: center;">
				...
				<s:iterator value="post">
					<table class="tables" class="tables"
					...
					<div class="author"
						style="width: 100%;; height: 35px; line-height: 35px;border-bottom: 2px solid #007cc1; margin-top: 15px; font-size: 12px; color: #6d6d6d; text-align: center;">
					...
					<table class="tables">
						<tbody>
							...
							<tr>
								<td>
							<div style="margin:10px;border-radius: 4px;text-align: left;text-indent: 20px;font-size: 14px;border: solid 0px #ccc;font-family: 微软雅黑;line-height:28px;margin:10px;">
							...
							<tr>
								<td>
									...
									<p style="line-height: 3em; font-size: 14px; float: left;">
										...
										附件下载：
										<a
											href="<%=path%>/down.action?inputPath=<s:property value="filename"/>">
											<s:property value="filename"></s:property> </a>
									</p>
