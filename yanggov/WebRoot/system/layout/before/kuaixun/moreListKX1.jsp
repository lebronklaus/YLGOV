							...
							<s:iterator value="%{#application.newsListkx}">
								<ul class="ula">
									<li>
										...
										<div class="wen">
											<a
												href="system/layout/addMoreNewsskx.action?id=<s:property value='kxid'></s:property>">
												<s:property value="title"></s:property> </a><span><s:property
													value="date" />
											</span>
										</div>
									</li>
					...
					<div class="xq_div6">
						<div class="pagin">
							<div class="message">
								...
								页记录，当前显示第
								<i class="blue"><s:property value="#application.pagenowkx" />
								</i>页
							</div>
							...
							<ul class="paginList">
								<li class="paginItem">
									<a
										href="<%=path%>/system/layout/morenewskxwk.action?PageNow=1"
										target="right"><span class="pagepre">首页</span> </a>
								</li>
								<li class="paginItem">
									<s:if test="#application.pagenowkx!=1">
										<a
											href="<%=path%>/system/layout/morenewskxwk.action?PageNow=<s:property value='#application.pagenowkx-1'/>"
								...
								<li class="paginItem">
									<a href="javascript:;"><s:property
											value='#application.pagenowkx' />
									</a>
								</li>

								<li class="paginItem current">
									<s:if test="#application.pagenowkx+1 <= #application.pagecountkx">
										<a style="cursor: pointer"
											href="<%=path%>/system/layout/morenewskxwk.action?PageNow=<s:property value='#application.pagenowkx+1'/>"><s:property
												value='#application.pagenowkx+1' />
										</a>
									</s:if>
								</li>
								<li class="paginItem current">
									<s:if test="#application.pagenowkx+2 <= #application.pagecountkx ">
										<a style="cursor: pointer"
											href="<%=path%>/system/layout/morenewskxwk.action?PageNow=<s:property value='#application.pagenowkx+2'/>"><s:property
												value='#application.pagenowkx+2' />
										</a>
									</s:if>
								</li>
								<!--                   下一页-->
								<li class="paginItem">
									<s:if test="#application.pagenowkx!=#application.pagecountkx">
										<a
											href="<%=path%>/system/layout/morenewskxwk.action?PageNow=<s:property value='#application.pagenowkx+1'/>"
								...
								<li class="paginItem">
									<a
										href="<%=path%>/system/layout/morenewskxwk.action?PageNow=<s:property value='#application.pagecountkx'/>"
