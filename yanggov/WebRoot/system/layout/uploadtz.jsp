...
<!-- 	<script type="text/javascript" src="system/layout/back/js/tzeidt.js"></script> -->
  ...
  <body>
    <form action="Tnewsfile" method="post" enctype="multipart/form-data" validate="true" style="font-size: 16px; font-family:微软雅黑;"style="font-size: 16px; font-family:微软雅黑;">
