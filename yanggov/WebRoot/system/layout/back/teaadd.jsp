...
<script type="text/javascript" src="system/layout/back/js/addtea.js"></script>
...
<body>
	...
	<div id="main" align="center" style="padding:10px;" class="easyui-panel"  title="师资管理—发布师资信息">
	<fieldset style="width:757px;">
			<legend style="font-size:20px;font-family: 微软雅黑;">发布师资信息</legend>
		...
		<table>
			...
			<tr>
				...
				<td colspan="3"><textarea style="width: 100%;height:330px;" class="form-control" id="inputNote" rows="5" name="tt.teacher_profile"></textarea>
			</tr>
			
			<tr>
				<td height="200"><span> 照&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;片：</span></td>
	...
	<span id="user_picpath" style="display:none;" ></span>
	<!--main -->
