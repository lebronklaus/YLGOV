...
<html>
  <head>
	...
	function save1(){
		 window.parent.deleteimg1($('#myimage').text());
	}
	$(document).ready(function() {
	 window.parent.save1($('#myimage').text());
	 if($('#base_id',window.parent.document).text().trim()){
		 $.post("./base/deleimage1",
	 			{
	 			base_path1:$('#myimage').text(),
  ...
  <body>
	...
	<td><s:form action="./base/upload1.action" method="POST"
	...
	<span id="myimage" style="display:none"><s:property value="showpath" /></span>
	<form id="form" action="./base/upload1.action" method="post" enctype="multipart/form-data" >
	<div>
