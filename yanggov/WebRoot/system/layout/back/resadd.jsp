...
<script type="text/javascript" src="system/layout/back/js/addres.js"></script>
...
<body>
	...
	<div id="main" align="center" style="padding:10px;" class="easyui-panel"  title="资源管理—发布培训资源">
		<fieldset style="width:757px;">
			<legend style="font-size:20px;font-family: 微软雅黑;">发布培训资源</legend>
			<div style="height:20px"></div>
		<table>
	
			<%-- <tr >
				<td style="height: 50px;font-weight: bold;" align="center" colspan="4"><span > 发布资源</span></td>
			</tr> --%>
			<tr>
				...
				<td><select id="colum" class="easyui-combobox" name="res.resources_colum"
					...
					panelHeight="auto">
					<option value="sp" >专家视频库</option>
                    <!-- <option value="gb" >广播演讲稿</option>  -->
                    <option value="wg" >专家文稿库</option>  
				</select></td>
			</tr>
			...
			<tr>
				...
				<td colspan="3"><textarea style="width: 100%;height:410px;" class="form-control" id="inputNote" rows="5" name="res.resources_profile"></textarea>
			</tr>
			<tr>
				<td height="100px" style="padding-bottom: 50px;">
				<span > 资源上传：</span></td>
	...
	<span id="res_path"  style="display:none;"></span>
	<!--main -->
