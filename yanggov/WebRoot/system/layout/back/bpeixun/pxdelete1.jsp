...
<script  type="text/javascript" src="system/layout/back/js/pxlist.js"></script>
<style>
body {
	padding: 0;
	margin: 0;
...
<script type="text/javascript">  
    $(function() {
        $('#dg').datagrid({  
            ...
            url:'peixunfind.action',//url调用Action方法  
            loadMsg : '数据装载中......',  
	...
	{	var s=$('#name').val();
			...
			collapsible : true,//显示可折叠按钮  
			toolbar : "#tb",//在添加 增添、删除、修改操作的按钮要用到这个  
			url : 'pxsearch.action?s='+encodeURI(encodeURI(s)),//url调用Action方法  
