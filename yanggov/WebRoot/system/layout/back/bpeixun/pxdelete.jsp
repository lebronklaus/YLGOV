	...
	<body>
		...
		<div class="rightinfo">
				...
				<tbody>
					<s:iterator id="strain1" value="list">
						<tr>
							...
							<td>
								<a href="<%=path %>/system/back/peixunde.action?id=<s:property value='dtid'/>"
									class="tablelink" onclick="return del()">刪除</a>
								<a href="<%=path %>/system/layout/addMoreNewssdt.action?id=<s:property value='dtid'/>" class="tablelink">查看</a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
			...
			<div class="pagin">
				...
				<ul class="paginList">
					<li class="paginItem">
						<a href="<%=path %>/system/back/peixunfind.action?PageNow=1"><span class="pagepre">首页</span>
						</a>
					</li>
					<li class="paginItem">
						<a href="<%=path %>/system/back/peixunfind.action?PageNow=<s:property value='pageNow-1'/>"><span
					...
					<li class="paginItem">
						<a href="<%=path %>/system/back/peixunfind.action?PageNow=<s:property value='pageCount'/>"><span
