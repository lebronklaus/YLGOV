...
<script type="text/javascript" src="system/layout/back/js/addkx.js"></script>
...
<body>
	...
	<legend style="font-size:20px;font-family: 微软雅黑;font-weight:bold;">三农快讯</legend>
		...
		<textarea     id="remark"  class="easyui-textbox"
			...
			<tr>
				...
				<td align="center"  height="50" colspan="4"  ><iframe name="framer"
						src="system/layout/back/bkuaixun/uploadkx.jsp" width=100% height="100%" frameborder="0"></iframe></td>
			</tr>
