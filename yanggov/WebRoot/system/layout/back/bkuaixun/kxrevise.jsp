...
<script type="text/javascript" src="system/layout/back/js/kxeidt.js"></script>
...
<body>
	...
	<legend style="font-size:20px;font-family: 微软雅黑;font-weight:bold;">三农快讯编辑</legend>
		<table style="margin-top: 20px;">
			 
			<tr>
				<td width="84" height="38"><span> 标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</span></td>
				<td width="624px" colspan="3"><input name="tt.title" id="title" class="easyui-textbox"
					style="width:98%;height:30px;" value="<s:property value="title"></s:property>"></td>
			...
			<tr>
				...
				<td colspan="3" width="624px"><textarea style="width: 98%;height:330px;" class="form-control" id="inputNote" rows="5" name="tt.teacher_profile"><s:property 	value="text" escape="false"/></textarea>
			</tr>
			<tr>
<!-- 				<td height="200"><span>上传文件：</span></td> -->
				<td align="center" colspan="3" height="50px"><iframe name="framer"
						src="system/layout/back/bkuaixun/uploadkx1.jsp" width=100% height="100%" frameborder="0"></iframe></td>
	 </tr>
...
<!-- 	<span id="user_picpath" ><s:property value="id"/></span> -->
	<span id="tzid" style="display:none;"><s:property value="kxid"/></span>
	</s:iterator>
	<!--main -->
