...
<script type="text/javascript" src="system/layout/back/js/addbase.js"></script>
...
<body>
	...
	<div id="main" align="center" style="padding:10px;" class="easyui-panel"  title="基地管理—发布基地信息">
	<fieldset style="width:757px;">
			<legend style="font-size:20px;font-family: 微软雅黑;">发布基地信息</legend>
			<div style="height:20px"></div>
		<table>
			<%-- <tr >
				<td style="height: 50px;font-weight: bold;" align="center" colspan="4"><span > 发布基地</span></td>
			</tr> --%>
			<tr>
				<td width="84" height="38"><span> 基地名称：</span></td>
				<td width="287"><input name="tb.base_name" id="basename" class="easyui-textbox"
					style="width:271px;height:30px;" required
					data-options="missingMessage:'必填'"></td>
						
				<td height="38"><span>联系人：</span></td>
				<td><input name="tb.base_contact"  id="contact"  class="easyui-textbox"
					style="width:271px;height:30px;"
					data-options="missingMessage:'必填'" required></span></td>
			</tr>
			<tr> <td><div style="height:3px;"></div></td></tr>
			<tr>
				<td height="38" valign="top"><span> 基地简介：</span></td>
				<td colspan="3"><textarea style="width: 100%;height:410px;" class="form-control" id="inputNote" rows="5" name="tb.base_profile"></textarea>
			</tr>
	...
	<span id="base_path1" style="display:none;" ></span>
	<span id="base_path2" style="display:none;"></span>
	<!--main -->
