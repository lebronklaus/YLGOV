...
<script  type="text/javascript" src="system/layout/back/js/zclist.js"></script>
<style>
body {
	padding: 0;
	margin: 0;
...
<script type="text/javascript">  
    $(function() {  
        $('#dg').datagrid({  
            ...
            url:'zhengcefind.action',//url调用Action方法  
            loadMsg : '数据装载中......',  
    ...
    function Search()
 		{ 
			...
			collapsible : true,//显示可折叠按钮  
			toolbar : "#tb",//在添加 增添、删除、修改操作的按钮要用到这个  
			url : 'zcsearch.action?s='+encodeURI(encodeURI(s)),//url调用Action方法  
...
<body>
	<table id="dg" title="政策列表" class="easyui-datagrid"
...
<!-- 				<th data-options="field:'ck',checkbox:false" field="id"></th> -->
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<div class="ftitle">政策信息</div>
		<div >
	<div class="fitem" style=" font-weight: bold;">
	<table>
	<tr>
		<td style=" font-weight: bold;">	<label>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</label></td>
		...
		<div class="fitem" style=" font-weight: bold;">
		<label>公开目录：</label> <span id="sswk"></span>
		</div>
		 <div class="fitem" style=" font-weight: bold;">
			<label>索&nbsp;引&nbsp;&nbsp;号：</label> <span id="suoyinhao"></span>
		</div>
  		<div class="fitem" style=" font-weight: bold;">
  		<label>主&nbsp;题&nbsp;&nbsp;词：</label> <span id="zhutici"></span>
  		</div>
  		
		<div class="fitem" style=" font-weight: bold;">
			<label>文&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</label> <span id="wenhao"></span>
		</div>
		<div class="fitem" style=" font-weight: bold;">
			<label>发布时间：</label> <span id="teacher_sex"></span>
		</div>
		</div>
