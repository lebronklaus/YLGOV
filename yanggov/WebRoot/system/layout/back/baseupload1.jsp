...
<script type="text/javascript" src="system/layout/back/js/jquery.min.js"></script>
	...
	function save1(){
		 window.parent.deletepic1($('#base_path1').attr("src"));
		
	}
	$(document).ready(function() {
	$('#base_path1').attr("src", <%=path%>+"upload/media/baseimage/"+$('#base_path1',window.parent.document).text());
	});
...
<body>
	<%-- <table>
	<tr>
	<td><img id="base_path1" width="120px" height="160px" /></td>
	...
	<div>
		<div style="float:left;"><img id="base_path1" width="120px" height="160px" /></div>
