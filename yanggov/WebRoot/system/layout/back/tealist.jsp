...
<script type="text/javascript" src="system/layout/back/js/tealist.js"></script>
<style>
body {
	padding: 0;
	margin: 0;
...
<script type="text/javascript">  
    $(function() {  
        $('#dg').datagrid({  
            ...
            url:'./teacher/teab.action',//url调用Action方法  
            loadMsg : '数据装载中......',  
...
<body>
	<table id="dg" title="师资列表" class="easyui-datagrid"
	...
	<input class="easyui-textbox" id="name" name="name"
			data-options="prompt:'请输入专家姓名'" style="width:15%"> 
	...
	<div id="dlg" class="easyui-dialog"
		...
		<div class="fitem">
			<label>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</label> <span id="teacher_name"></span>
		</div>
		<div class="fitem">
			<label>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</label> <span id="teacher_sex"></span>
		</div>
		<div class="fitem">
			<label>工作单位：</label> <span id="teacher_workplace"></span>
		</div>
		<div class="fitem">
			<label>是否在职：</label> <span id="teacher_inwork"></span>
		</div>
		<div class="fitem">
			<label>技术职称：</label> <span id="teacher_professional"></span>
		</div>
		<div class="fitem">
			<label>单位电话：</label><span id="teacher_phonenum"></span>
		</div>
		<div class="fitem">
			<label>联系地址：</label> <span id="teacher_address"></span>
		</div>
		<div class="fitem">
			<label>电子邮件：</label> <span id="teacher_email"></span><span id="grprof2"></span>
		</div>
		<div class="fitem">
			<label>毕业院校：</label> <span id="teacher_university"></span>
		</div>
		<div class="fitem">
			<label>专业领域：</label> <span id="teacher_major"></span>
		</div>
		<div class="fitem">
			<label>个人简介：</label> <div style="margin:10px;border: 1px solid #ccc;border-radius: 4px;font-size: 14px;font-family: 微软雅黑;" id="teacher_profile"></div>
