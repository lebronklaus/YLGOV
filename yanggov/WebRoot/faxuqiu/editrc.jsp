...
<body>
	...
	<div id="main" align="center" style="padding:10px;"class="easyui-panel"  title="编辑需求—修改人才需求">
	<fieldset style="width:757px;">
			<legend style="font-size:20px;font-family: 微软雅黑;font-weight:bold;">修改人才需求</legend>
		...
		<table>
			...
			<tr>
				...
				<td><select id="type" class="easyui-combobox" required data-options="missingMessage:'必填'"
					...
					panelHeight="auto">
    					<option <s:if test='rcxq.mark ==1'> selected ="selected" </s:if> value="1">企业</option>
    					<option <s:if test='rcxq.mark ==2'> selected ="selected" </s:if> value="2">园区</option>
					</select>
			</tr>
			<tr>
				<td width="84" height="38"><span>岗位名称：</span></td>
				<td width="287"><input name="tt.teacher_name" id="gangwei" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="rcxq.gangwei"/>"></td>
				
				<td width="84" height="38"><span>需求人数：</span></td>
				<td width="287"><input name="tt.teacher_name" id="renshu" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="rcxq.renshu"/>"></td>
			</tr>
			...
			<tr>
				...
				<td><input name="tt.teacher_workplace"  id="daogangtime"  class="easyui-textbox"
					...
					value="<s:property value="rcxq.daogangtime"/>"></td>
				
				<td height="38"><span> 薪资待遇：</span></td>
				<td><input name="tt.teacher_workplace"  id="salary"  class="easyui-textbox"
					style="width:285px;height:30px;"
					value="<s:property value="rcxq.salary"/>"></td>
			</tr>
			<tr> <td><div style="height:3px;"></div></td></tr>
			<tr>
				<td valign="top" height="38"><span>岗位描述：</span></td>
				<td colspan="3"><textarea style="width: 100%;height:330px;" class="form-control" id="inputNote1" rows="5" name="tt.teacher_profile"><s:property value="rcxq.discrip" escape="false"/></textarea>
			</tr>
			...
			<tr>
				...
				<td><input  name="tt.teacher_phonenum" id="region" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="rcxq.region"/>"></td>
						
				<td height="38"><span> 年龄范围：</span></td>
				<td><input  name="tt.teacher_phonenum" id="agerank" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="rcxq.agerank"/>"></td>
			</tr>
			
			<tr>
				<td height="38"><span> 学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;历：</span></td>
				<td><input name="tt.teacher_university"  id="xueli" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="rcxq.xueli"/>"></td>
						
				<td height="38"><span> 专&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;业：</span></td>
				<td><input name="tt.teacher_major"  id="major" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="rcxq.major"/>"></td>
			</tr>
			
			<tr> <td><div style="height:3px;"></div></td></tr>
			<tr>
				<td valign="top" height="38"><span> 岗位经验：</span></td>
				<td colspan="3"><textarea style="width: 100%;height:330px;" class="form-control" id="inputNote2" rows="5" name="tt.teacher_profile"><s:property value="rcxq.experience" escape="false"/></textarea>
			</tr>
			<tr> <td><div style="height:3px;"></div></td></tr>
			<tr>
				<td  valign="top" height="38"><span> 岗位说明：</span></td>
				<td colspan="3"><textarea style="width: 100%;height:330px;" class="form-control" id="inputNote3" rows="5" name="tt.teacher_profile"><s:property value="rcxq.shuoming" escape="false"/></textarea>
			</tr>
		</table>
	...
	<!--main -->
	<span id = "rc_id" style="display:none;"><s:property value="rcxq.id"  /></span>
