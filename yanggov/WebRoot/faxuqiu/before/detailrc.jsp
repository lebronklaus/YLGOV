...
<div class="xq_zhong_3">
		<div class="xq_div2_div1_3">
				<div class="xq_div2_top">
					...
					<div class="xq_top_wen_3">
						<span>您当前位置： 需求征集> <a id ="peixun">人才需求</a></span>					
					</div>				
				</div>
		</div>
		...
		<!--简介-->
	    <div id="info">
	    	<div class="title">人才需求</div>
	        <div style="line-height: 20px;padding-left: 2em; border: dashed 1px #cacaca; font-family: 微软雅黑;font-size: 14px;">
                   
                    <ol style="list-style-type:demical;width:500px;">
                      <li style=" list-style-position:inside;">1.&nbsp;招聘职位是<s:property value="gangwei"/></li>
                      <li style=" list-style-position:inside;">2.&nbsp;要求到岗时间为<s:property value="daogangtime"/></li>
                      <li style=" list-style-position:inside;">3.&nbsp;需要的人数是<s:property value="renshu"/>人</li>
                      <li style=" list-style-position:inside;">4.&nbsp; 薪资待遇是<s:property value="salary"/>元</li>
                    </ol>
	        </div>
	    </div>
	    ...
	    <div id="info">
	       ...
	       <div style="display: block;line-height: 20px;    padding: 9.5px;padding-left: 10px; border: dashed 1px #cacaca;border-radius: 4px;font-size: 14px;font-family: 微软雅黑;">
		     <s:property value="discrip" escape="false"/>
	        </div>
	    </div>
	...
	<!--简介-->
	    <div id="info">
	        ...
	        <div style="line-height: 20px;padding-left: 2em; border: dashed 1px #cacaca;font-family: 微软雅黑;font-size: 14px; ">
                    ...
                    <ol style="list-style-type:demical;width:500px;">
                      <li style=" list-style-position:inside;">1.&nbsp;性别要求是<s:property value="sex"/></li>
                      <li style=" list-style-position:inside;">2.&nbsp;年龄范围是<s:property value="agerank"/></li>
                      <li style=" list-style-position:inside;">3.&nbsp;学历要求是<s:property value="xueli"/></li>
                      <li style=" list-style-position:inside;">4.&nbsp;专业要求是<s:property value="major"/></li>
                    </ol>
	        </div>
	    </div>
	    <!--简介-->
	    <div id="info0">
	    	<div class="title">岗位经验</div>
	        ...
	        <div style="display: block;line-height: 20px;    padding: 9.5px;padding-left: 10px; border: dashed 1px #cacaca;border-radius: 4px;font-size: 14px;font-family: 微软雅黑;" >
			    <s:property value="experience" escape="false"/>
	        </div>
	    </div>
	    <div id="info1">
	       ...
	       <!--  <pre style="line-height: 20px;padding-left: 10px; border: dashed 1px #cacaca; white-space: pre-wrap; white-space: -moz-pre-wrap; white-space: -pre-wrap; white-space: -o-pre-wrap; word-spacing: break-word;"> -->
	       <div style="display: block;line-height: 20px;    padding: 9.5px;padding-left: 10px; border: dashed 1px #cacaca;border-radius: 4px;font-size: 14px;font-family: 微软雅黑;">
		     <s:property value="shuoming" escape ="false"/>
	        </div>
	    </div>
	  </s:iterator>
  </div>
