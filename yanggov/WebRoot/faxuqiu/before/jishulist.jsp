...
<html>
  ...
  <body >
  	...
  	<div class="xq_div2_div4">
			<div class="ind_lie_tong1">
				<div class="lie_tong_left">
					<ul>
						<li class="bei"><a href="javascript:void(0)">技术</a></li>
			...
			<div class="xq_div2_div3_sp">
				...
				<s:iterator value="list2">
					<li>
						...
						<div class="wen"><a href="showjishu.action?id=<s:property value="id"/>" target="_parent"><s:property value="mingcheng"/></a><span><s:property value="time"/></span></div>						
					</li>
				</s:iterator>						
				</ul>				
			</div>
  	...
  	<div class="pagin" style="width:708px;">
				...
				<ul class="paginList">
					<li class="paginItem">
						<a href="jishusearch.action?PageNow=1"><span class="pagepre">首页</span>
						</a>
					</li>
					<li class="paginItem">
						<s:if test="pageNow!=1"><a href="jishusearch.action?PageNow=<s:property value='pageNow-1'/>"><span
					...
					<li class="paginItem current">
							<s:if test="pageNow +1 <= pageCount"><a style="cursor:pointer" href="jishusearch.action?PageNow=<s:property value='pageNow+1'/>"><s:property value='pageNow+1'/></a>
							</s:if>
					</li>
					<li class="paginItem current">
						<s:if test="pageNow+2 <= pageCount"><a style="cursor:pointer" href="jishusearch.action?PageNow=<s:property value='pageNow+2'/>"><s:property value='pageNow+2'/></a>
							</s:if>
					</li>
					
					<li class="paginItem">
						<s:if test="pageNow!=pageCount"><a href="jishusearch.action?PageNow=<s:property value='pageNow+1'/>"><span
							class="pagepre">下一页</span>
						</a></s:if>
					</li>
					<li class="paginItem">
						<a href="jishusearch.action?PageNow=<s:property value='pageCount'/>"><span
