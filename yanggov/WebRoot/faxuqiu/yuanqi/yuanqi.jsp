...
<script language="javascript" type="text/javascript"> 
	...
	$("#rightFrm").attr("src",host+"/yanggov/qiyelist.action");
	 */
...
function changebg(var1){
	if(var1==qiye){
		$("#qiye").css("background","#f0f0f0");
		$("#yuanqu").css("background","#fff");
	}else if(var1 == yuanqu ){
		$("#qiye").css("background","#fff");
		$("#yuanqu").css("background","#f0f0f0");
	}
}
function qiye(){
	changebg(qiye);
	$('#rightFrm').attr("src","qiyelist.action");
	$('#yuanqi').html("企业信息");
	
}
function yuanqu(){
	changebg(yuanqu);
	$('#rightFrm').attr("src","yuanqulist.action");
	$('#yuanqi').html("园区信息");
}
...
<div class="top">
	...
	<div class="logo">
		<a href="javascript:void(0)"><img src="/yanggov/images/logo.png" /></a>
	</div>
</div>
	...
	<div class="xq_left" style="height:1000px;">
		<div class="xq_left_div">
			...
			<div class="xq_div_div2">
				<ul>
					<li id="qiye"class="qie">
						<a id="qiye" href="javascript:void(0)" onclick="qiye()">企业信息</a>					
					</li>
					<li id="yuanqu"class="li">
						<a id="yuanqu" href="javascript:void(0)" onclick="yuanqu()">园区信息</a>					
					</li>
				</ul>
			</div>
			<div style="clear:both;"></div>
			...
			<div class="xq_div2_div1">
				<div class="xq_div2_top">
					...
					<div class="xq_top_wen">
						<span>您当前位置： 园企信息> <a id ="yuanqi">企业信息</a></span>					
					</div>				
				</div>
			</div>
			
			<div class="xq_div2_div2">
				<iframe id ="rightFrm" src="qiyelist.action" name="rightFrm"  frameborder="0" scrolling="no" width="100%" height="100%"></iframe>
			</div>
			<div style="clear:both;"></div>
		</div>
	</div>	
