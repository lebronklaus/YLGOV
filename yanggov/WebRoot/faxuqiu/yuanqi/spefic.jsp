		...
		<div class="xq_div2_div1_3">
				<div class="xq_div2_top">
					...
					<div class="xq_top_wen_3">
						<span>您当前位置： 园企信息> <a id ="peixun">企业信息</a></span>					
					</div>				
				</div>
		</div>
	  <div style="width:100%;">
	  	<table class="tables" style="width: 100%;  margin-top:10px">
				<thead>
					<tr>
						<td><s:property value="tzhi.name"/></td>
					</tr>
				</thead>
		</table>

		<div style="  width:100%;height: 20px; line-height: 20px;  margin-top: 10px;   font-size: 12px;  color: #6d6d6d; text-align: center;">
			<span id='fzr'>企业负责人：</span>
			<s:property value="tzhi.fuzeren"/>&nbsp;&nbsp;|
			<span>联系电话：</span>
			<s:property value="tzhi.tel"/>&nbsp;&nbsp;|
			<span>联系地址：</span>
			<s:property value="tzhi.address"/>
		</div>
		<!--分割线-->
    	<div class="left_article_line_right" style="width:1178px;"></div>
          <div style="height:30px"></div>
          <s:if test='tzhi.path1!=""   '>
	          <div style="height: 505px;margin-top: 30px;background: #949494;padding: 10px;border-radius: 10px;width: 765px;margin: 0 auto;">
		          <div id="slideBoxx" class="slideBoxx">			
						<div class="bd">
							<ul>
								<li>
									<a href="javascript:void(0)" target="_blank"><img src="upload/media/yuanqiimage/<s:property value="tzhi.path1"/>"/></a>
									<div class="xq_tou">
										<span>远景</span>
									</div>
								</li>
								...
								<li>
									<a href="javascript:void(0)" target="_blank"><img src="upload/media/yuanqiimage/<s:property value="tzhi.path2"/>"/></a>
									<div class="xq_tou">
										<span>近景 </span>
									</div>
								</li>
	    ...
	    <!--简介-->
	    <div id="info">
	    	<div id='jj' class="title">企业简介</div>
	        ...
	        <div style="display: block;line-height: 20px;    padding: 9.5px;padding-left: 10px; border: dashed 1px #cacaca;border-radius: 4px;font-size: 14px;font-family: 微软雅黑;" id="teacher_profile">
		     <s:property value="tzhi.intro" escape="false" />
	       </div>
	    </div>
  </div>
...
<span  id="mark" style="display:none;"><s:property value="tzhi.mark"/></span>
</body>
</html>
