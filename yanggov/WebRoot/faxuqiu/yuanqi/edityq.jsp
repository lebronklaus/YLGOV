...
<body>
	...
	<fieldset style="width:757px;">
			<legend  id="qiye" style="font-size:20px;font-family: 微软雅黑;">修改企业信息</legend>
			<legend  id="yuanqu" style="font-size:20px;font-family: 微软雅黑;">修改园区信息</legend>
		...
		<table>
			...
			<tr>
				...
				<td><select id="type" class="easyui-combobox" required data-options="missingMessage:'必填'"
					...
					panelHeight="auto">
    					<option <s:if test='yqxx.mark ==1'> selected ="selected" </s:if> value="1" >企业</option>
    					<option <s:if test='yqxx.mark ==2'> selected ="selected" </s:if> value="2">园区</option>
					</select>
			</tr>
			<tr>
				...
				<td width="287"><input name="tb.base_name" id="name" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="yqxx.name"/>"></td>
						
				<td height="38"><span id="fuzeren"> 负责人&nbsp;&nbsp;&nbsp;：</span>
				</td>
				<td><input name="tb.base_contact"  id="fuzeren"  class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="yqxx.fuzeren"/>"></td>
			</tr>
			<tr>
				<td width="84" height="38"><span> 联系电话：</span></td>
				<td width="287"><input name="tb.base_name" id="tel" class="easyui-textbox"
					style="width:285px;height:30px;"  value="<s:property value="yqxx.tel"/>"></td>
						
				<td height="38"><span> 联系地址：</span></td>
				<td><input name="tb.base_contact"  id="address"  class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="yqxx.address"/>"></td>
			</tr>
			...
			<tr>
				...
				<td colspan="3"><textarea style="width: 100%;height:330px;" class="form-control" id="inputNote" rows="5" name="tb.base_profile"><s:property 	value="yqxx.intro" escape="false"/></textarea>
			</tr>
	...
	<!--main -->
	<span id = "yq_id" style="display:none;"><s:property value="yqxx.id"  /></span>
