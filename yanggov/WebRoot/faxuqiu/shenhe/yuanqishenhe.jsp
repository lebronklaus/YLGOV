...
<script type="text/javascript" src="faxuqiu/shenhe/js/yuanqi.js"></script>
<style>
body {
	padding: 0;
	margin: 0;
...
<script type="text/javascript">  
    $(function() {  
        $('#dg').datagrid({  
            ...
            url:'yuanqi.action',//url调用Action方法  
            loadMsg : '数据装载中......',  
...
<body>
	<table id="dg" title="技术审核" class="easyui-datagrid"
	...
	<div id="toolbar">
		<input class="easyui-textbox" id="name" name="name"
			data-options="prompt:'请输入园企名称'" style="width:15%"> 
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<div class="ftitle">园企信息</div>
		<div class="fitem" style="float:left">
			<img id="yuanqiimg1" height="160" width="300" style="border:1px solid;">
		</div>
		<div class="fitem" style="float:right">
			<img id="yuanqiimg2" height="160" width="300" style="border:1px solid;">
			
		</div>
		<div style = "clear:both;"></div>
		<div class="fitem">
			<label>园企名称：</label> <span id="yuanqiname"></span>
		</div>
		<div class="fitem">
			<label>负责人&nbsp;&nbsp;&nbsp;：</label> <span id="fuzeren"></span>
		</div>
		<div class="fitem">
