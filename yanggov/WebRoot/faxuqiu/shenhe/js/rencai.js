	...
	var rowid;
		function formatOper(val, row, index) {
			return '<a href="javascript:void(0)" onclick="showUser(' + index
					+ ')">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="editRC(' + index
		...
		//修改
				function editRC(index){
					...
					if(row){
						...
						$('#show',window.parent.document).attr("src","../../yanggov/editrencai.action?id="+row.id+"&type="+row.mark); //add to szl
					}
					//resizeres();
				}
