...
<body>
	...
	<div id="main" align="center" style="padding:10px;" class="easyui-panel"  title="编辑需求—修改技术需求">
	<fieldset style="width:757px;">
			<legend style="font-size:20px;font-family: 微软雅黑;font-weight:bold;">修改技术需求</legend>
		...
		<table>
			...
			<tr>
				...
				<td><select id="type" class="easyui-combobox" required data-options="missingMessage:'必填'"
					...
					panelHeight="auto">
    					<option <s:if test='jsxq.mark ==0'> selected ="selected" </s:if> value="0">农民</option>
    					<option <s:if test='jsxq.mark ==1'> selected ="selected" </s:if> value="1">企业</option>
    					<option <s:if test='jsxq.mark ==2'> selected ="selected" </s:if> value="2">园区</option>
					</select>
			</tr>
			<tr>
				<td width="84px" height="38"><span>需求名称：</span></td>
				<td width="287"><input name="tt.teacher_name" id="mingcheng" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="jsxq.mingcheng"/>"></td>
				...
				<td><select id="lingyu" class="easyui-combobox" name="tt.teacher_sex"
					...
					style="width:285px;height:30px;" editable="false"
					panelHeight="auto">
						<option <s:if test='jsxq.lingyu == "zhongzhi"'> selected ="selected" </s:if> value="zhongzhi">种植</option>
	                    <option <s:if test='jsxq.lingyu == "yangzhi"'> selected ="selected" </s:if> value="yangzhi" >养殖</option>                      
	                    <option <s:if test='jsxq.lingyu == "nongzi"'> selected ="selected" </s:if> value="nongzi" >农资</option>                      
	                    <option <s:if test='jsxq.lingyu == "jiagong"'> selected ="selected" </s:if> value="jiagong" >加工</option>                      
	                    <option <s:if test='jsxq.lingyu == "nongji"'> selected ="selected" </s:if> value="nongji" >农机</option>                      
	                    <option <s:if test='jsxq.lingyu == "nengyuan"'> selected ="selected" </s:if> value="nengyuan" >能源</option>                      
	                    <option <s:if test='jsxq.lingyu == "fuwu"'> selected ="selected" </s:if> value="fuwu" >服务</option>                      
	                    <option <s:if test='jsxq.lingyu == "qita"'> selected ="selected" </s:if> value="qita" >其他</option>   
				</select></td>
			</tr>
			...
			<tr id="tr5">
				...
				<td><input  name="tt.teacher_address" id="email" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="jsxq.email"/>"></td>
			</tr>
			
			<tr id="tr6">		
				<td width="84px" height="38"><span> 邮政编码：</span></td>
				<td><input  name="tt.teacher_email" id="youbian" class="easyui-textbox"
					style="width:285px;height:30px;" value="<s:property value="jsxq.youbian"/>"></td>
			</tr>
			<!-- 
			<tr id="tr7" >
				<td width="84px" height="38"><span> 电子邮件：</span></td>
			...
			<tr>
				...
				<td colspan="3"><textarea style="width: 100%;height:410px;" class="form-control" id="inputNote" rows="5" name="tt.teacher_profile"><s:property 	value="jsxq.shuoming" escape="false"/></textarea>
			</tr>
		</table>
	...
	<!--main -->
		<span id = "js_id" style="display:none;"><s:property value="jsxq.id"  /></span>
