...
<script language="javascript" type="text/javascript"> 
	...
	$("#border").height(height < 1010 ? 1010 : height); 
	/* $("#bd").height(2000); */
	}); 
	$("#slid").slide({mainCell:".xq_div1_div2 ul",autoPlay:true,effect:"topMarquee",vis:6,interTime:50}); 
	changebg(ziliao);
	}); 
...
<div class="xq_zhong">
	<div class="xq_left" style="height:1000px" >
		...
		<div id="slid" class="xq_left_div2">
			<div class="xq_div_div1">
				<h1>通知公告</h1>			
			</div>			
	...
	<div class="xq_right">
		<div id="border" class="xq_right_div2">
			...
			<div class="xq_div2_div2">
				<iframe id ="rightFrm" src="./teacher/search.action?name=<s:property value="name" />" name="rightFrm"  frameborder="0" scrolling="no" width="100%" height="100%"></iframe>
			</div>
			<!-- <div style="clear:both;"></div> -->
		</div>
	</div>	
